...
2. **นโยบายแก้ไขข้อขัดแย้ง (Conflict Resolution Policy)**: หากงานที่ทำขัดแย้งกับกฎ (Rule) หรือ Skill ให้ระบุข้อขัดแย้งนั้น แล้วสอบถามผู้ใช้ว่าจะเลือก **(A)** ทำตาม Rule/Skill หรือ **(B)** ทำตามวิธีของผู้ใช้ (และอาจอัปเดต Rule/Skill เพิ่มเติม) ห้ามเพิกเฉยหรือข้ามข้อขัดแย้งโดยไม่แจ้งเด็ดขาด (รายละเอียด: `vinai-project-conventions.mdc`)
