...
4. **อัปเดต Checklist ในไฟล์ plan เมื่อทำงานตาม plan เสร็จ**: หลังจาก implement จบแต่ละ phase/งานตามที่ได้รับมอบหมาย ให้กลับไปอัปเดต checklist (`[x]`) ในไฟล์ plan (เช่น `plans/sub-plan-*.md`) พร้อมหมายเหตุผลลัพธ์/ข้อสรุปที่ไม่ต้องทำจริง ก่อนปิดงานทุกครั้ง
