...
| Task Dependencies | กำหนดงานที่ต้องทำก่อน-หลัง |
...
| Gantt / Timeline | ดูงานแบบ Gantt chart (frappe-gantt) |
...
| ฟีเจอร์ | เหตุผล |
|---------|--------|
| **Dashboard / Overview** | หน้าหลักรวมภาพรวม — งานค้าง, งานเลยกำหนด, ภาระทีม, progress รายโปรเจกต์ |
...
| **Task Dependencies Visualization** | แสดง dependency เป็นเส้นบน Gantt (ปัจจุบันมี data แต่ไม่ได้แสดง) |
